...
<html lang="es">
  <head>
  <meta charset="utf-8">
  <title>Eventus - Editar Paquete</title>
  ...
  <script src="../controllers/update_paquete_controller.js"></script>
</head>
<body>
  ...
  <div class="row container">
    <div class="col-sm-6 col-md-6 col-lg-6 mx-auto">
      <div class="card card-signin my-5">
        <div class="card-body">
          <h5 class="card-title text-center">Editar Paquete</h5>
          <form class="form-nueva-categoria">
            <input type="hidden" id="paquete" value="<?php echo $_POST['id']; ?>">
            ...
            <div class="form-label-group">
              <input type="number" min="0" step="0.01" id="price" class="form-control" placeholder="Precio" required  value="<?php echo $_POST['price']; ?>">
            </div>
            <div class="form-label-group">
              <input type="text" id="imagen" class="form-control" placeholder="URL de la Imagen" required  value="<?php echo $_POST['image']; ?>">
            </div>
